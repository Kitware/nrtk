"""This module contains definitions for non-task specific MAITE-compliant datum-level metadata."""

from __future__ import annotations

__all__ = ["NRTKDatumMetadata", "_forward_md_keys"]
...
class NRTKDatumMetadata(DatumMetadata):  # pyright:  ignore [reportGeneralTypeIssues]
    """Dataclass for NRTK-perturbed datum-level metadata."""
