...
class StoreScenario(Plugfigurable):
    ...
    def __init__(self,
        ...
        assert ihaze in StoreScenario.ihaze_values
        assert altitude in StoreScenario.altitude_values
        assert groundRange in StoreScenario.groundRange_values
