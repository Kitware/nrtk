...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            [0],
            pytest.raises(ValueError, match=r"Factory passed in with invald length of 0"),
        ),
        ([1], does_not_raise()),
        (
            [1, 0],
...
def test_gen_perturber_combinations(factory_lengths: Sequence[int], expectation: ContextManager) -> None:
    with expectation:
