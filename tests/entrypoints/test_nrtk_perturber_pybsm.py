...
def _load_dataset(dataset_path: str, load_metadata: bool = True) -> COCOMAITEObjectDetectionDataset:
...
@pytest.mark.skipif(
    not COCOMAITEObjectDetectionDataset.is_usable(),
    reason="COCOMAITEObjectDetectionDataset not usable",
)
