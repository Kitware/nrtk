...
class TestPybsmSensor:
    ...
    def test_sensor_call(self) -> None:
        D = 0  # noqa:N806
        f = 0
        p_x = 0.1
        opt_trans_wavelengths = np.array([0.58 - 0.08, 0.58 + 0.08]) * 1.0e-6
    ...
    def test_check_opt_trans_wavelengths_valid(self, sensor_instance: PybsmSensor) -> None:
    ...
    def test_check_opt_trans_wavelengths_too_few_elements(self, sensor_instance: PybsmSensor) -> None:
    ...
    def test_check_opt_trans_wavelengths_not_ascending(self, sensor_instance: PybsmSensor) -> None:
    ...
    def test_set_optics_transmission_none(self, sensor_instance: PybsmSensor) -> None:
    ...
    def test_set_optics_transmission_valid_array(self, sensor_instance: PybsmSensor) -> None:
    ...
    def test_set_optics_transmission_mismatched_length(self, sensor_instance: PybsmSensor) -> None:
